...
app.get('/collections/:collectionId/:docId', (req: Request, res: Response) => {
...
app.get('/collections/:collectionId', (req: Request, res: Response) => {
  console.info('[GET]', req);
...
app.post('/collections/:collectionId/:docId', (req: Request, res: Response) => {
...
app.put('/collections/:collectionId/:docId', (req: Request, res: Response) => {
